...
const FeaturedProjects = () => {
  const featuredProjects = [
    {
      title: "New Ecom",
      description: "A modern e-commerce platform built with PHP, featuring seamless shopping experiences, advanced product filtering, and secure payment integration.",
      technologies: ["HTML", "CSS", "JavaScript", "PHP", "MySQL"],
      link: "#",
      github: "https://github.com/Bobbiehex/eBobs",
    ...
    },
    {
      ...
      link: "#",
      github: "https://github.com/Bobbiehex/alpha",
      status: "Payment Integrated",
      highlight: "Fintech Solution"
    }
  ];
